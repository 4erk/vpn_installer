...
4. QUIC-профиль не использует `urltest`: sing-box не переигрывает неудачный запрос через следующий outbound, поэтому latency-selector создавал длинное ожидание вместо failover
