...
ENV_SECTIONS = [
    ...
    ("# Abuse guard: temporary nftables blocks from SSH noise; REALITY is observe-only by default", ["GUARD_ENABLED", "GUARD_INTERVAL_MINUTES", "GUARD_LOOKBACK_MINUTES", "GUARD_BLOCK_TIMEOUT", "GUARD_SSH_FAILURE_THRESHOLD", "GUARD_REALITY_INVALID_THRESHOLD", "GUARD_REALITY_BLOCK_ENABLED"]),
    ...
    ("# sing-box / VLESS + REALITY", ["CLIENT_UUID", "CLIENT_FLOW", "RU_LISTEN_PORT", "RU_REALITY_SERVER_NAME", "RU_REALITY_HANDSHAKE_SERVER", "RU_REALITY_HANDSHAKE_PORT", "RU_REALITY_PRIVATE_KEY", "RU_REALITY_PUBLIC_KEY", "RU_REALITY_SHORT_ID", "RU_REALITY_ACCEPT_EMPTY_SHORT_ID", "RU_REALITY_MAX_TIME_DIFFERENCE", "UTLS_FINGERPRINT", "SING_BOX_LOG_LEVEL", "RU_SNIFF_TIMEOUT", "TO_FOREIGN_CONNECT_TIMEOUT"]),
    ...
    ("# Forced policy rules for the Russian server: Russian APIs, reachability checks, IP-check services", ["RU_FORCE_DIRECT_DOMAIN", "RU_FORCE_DIRECT_DOMAIN_SUFFIX", "RU_FORCE_DIRECT_IP_CIDR", "RU_BLOCK_IP_CIDR", "RU_IPV6_POLICY", "RU_BLOCK_QUIC", "RU_GEOIP_DIRECT"]),
