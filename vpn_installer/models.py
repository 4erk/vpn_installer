...
ENV_SECTIONS = [
    ...
    ("# Abuse guard: temporary nftables blocks from SSH and REALITY noise", ["GUARD_ENABLED", "GUARD_INTERVAL_MINUTES", "GUARD_LOOKBACK_MINUTES", "GUARD_BLOCK_TIMEOUT", "GUARD_SSH_FAILURE_THRESHOLD", "GUARD_REALITY_INVALID_THRESHOLD"]),
