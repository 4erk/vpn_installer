...
def generate_default_env(deploy_name: str) -> dict[str, str]:
    ...
    return {
        ...
        "HEALTH_THROUGHPUT_URL": "https://speed.cloudflare.com/__down?bytes=2000000",
        "HEALTH_MIN_FOREIGN_DIRECT_DOWNLOAD_BPS": "500000",
        "HEALTH_MIN_RU_WG_DOWNLOAD_BPS": "500000",
