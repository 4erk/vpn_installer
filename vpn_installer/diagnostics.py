...
class DiagnosticsSnapshot:
    ...
    def from_preflight(cls, preflight: dict[str, str], *, deployment: str = "") -> "DiagnosticsSnapshot":
        ...
        top_destinations = {
            "domain_to_foreign_timeout": preflight.get("singbox_recent_timeout_destinations", ""),
            "ipv4_literal_timeout": preflight.get("singbox_recent_ip_literal_timeout_destinations", ""),
            "ipv6_literal_timeout": preflight.get("singbox_recent_to_foreign_ipv6_literal_destinations", ""),
